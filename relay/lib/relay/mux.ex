defmodule Relay.Mux do
  @moduledoc """
  Stream-multiplexing frame codec.

  Vendored from backend/lib/legend/core/tunnel/mux.ex — wire format MUST stay
  byte-compatible. The wire is the cross-process contract shared with the
  in-sprite bridge (`bridge/src/mux.rs`); keep all three in lockstep.
